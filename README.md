...
2. Create a **React** app from scratch using NPX and **take a screenshot of it**
3. Launch the TODO starter app, connect it to the database, and display your changes from the database. **Take a screenshot of your unique items in the to-do list**
4. Submit your homework [here](https://github.com/datastaxdevs/appdev-week1-todolist/issues/new?assignees=HadesArchitect%2C+SonicDMG%2C+RyanWelford&labels=homework%2C+wait+for+review&template=homework-assignment.md&title=%5BHW%5D+%3CNAME%3E), taking care of _never submitting your Astra DB token_.
